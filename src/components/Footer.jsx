                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        ...
                        <ul className="list-unstyled">
                            <li>
                                <span className="hotline">Hotline: 1900-6035</span>
                            </li>
                            ...
                            <li>
                                <a href="#">Bảo mật báo mật: security@tiki.vn</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="col-md-2">
                        ...
                        <h5 className="certification">Chứng nhận bởi</h5>
                        <a
                    ...
                    <div className="col-md-2 nowrap-text">
                ...
                <div className="row mt-3">
                    <div className="col-12">
                        ...
                        <p>
                            ...
                            Đầu Tư Thành phố Hồ Chí Minh cấp lần đầu ngày 06/01/2010.
                        </p>
